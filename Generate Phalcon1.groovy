...
def generate(out, className, fields, table) {
  ...
  fields.each() {
    ...
    out.println "   * @comment = ${it.comment.toString()}"
    out.println "   */"
    out.println "  public function set${it.name.capitalize()}(\$${it.name})"
    out.println "  {"
  ...
  out.println "   * @key = database column"
  out.println "   * @value = property"
  out.println "   */"
  out.println "  public function columnMap()"
  out.println "  {"
  out.println "    return ["
  fields.each() {
    out.println "        \"${it.cname}\" => \"${it.name}\","
  }
  out.println "    ];"
  out.println "  }"
